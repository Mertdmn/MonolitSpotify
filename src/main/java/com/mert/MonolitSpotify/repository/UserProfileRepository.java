...
/**
 * DİKKAT!!!!!!
 * Spring 3.X ile birlikte Repositoory sınıfların üzerinde ekleme @Repository anatosyonu kaldırılmıştır.
 */
@Repository
public interface UserProfileRepository extends JpaRepository<UserProfile,Long> {
     ...
     *
     */
    UserProfile findByResimUrl(String bak_simdi_buraya_resimurl_si_vereceksin);
     ...
     * girilen değer ile tutulmuş olan değer büyük küçük harf sorununa takılabilir. bunun için
    ...
    /**
     *
     * Spring Data Jpa açısında kendi kelimelerini desteklesede daha karmaşık sorgular ve
    ...
    @Query("select new com.mert.MonolitSpotify.repository.view.VwUserProfile(u.id,u.userName,u.resimUrl) from UserProfile u")
    List<VwUserProfile> findAllFromUserProfileView();

//    @Query("select new com.mert.MonolitSpotify.dto.response.FindAllUserProfileResponseDto(u.id,u.userName,u.resimUrl) from UserProfile u")
